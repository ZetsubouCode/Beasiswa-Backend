...
define('DB_USERNAME','detr8385_usrrlawyer');
define('DB_PASSWORD','Detar888Lawyer123');
define('DB_NAME','detr8385_dbrrlawyer');
...
$upload_url = 'http://'.$server_ip.'/probinterbusih/'.$upload_path;
